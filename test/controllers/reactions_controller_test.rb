...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { comment_id: @reaction.comment_id, type: @reaction.type, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { comment_id: @reaction.comment_id, type: @reaction.type, user_id: @reaction.user_id } }
